# general_agent.py
from agent_behaviours import go_towards_target, enforce_field_boundaries
    ...
    def act(self, frame):
        if self.target_position is not None:
            ...
            if robot_data and self.world2robot_fn:
                ...
                #self.vx, self.vy = enforce_field_boundaries(robot_data['x'], robot_data['y'], self.vx, self.vy)
                enforce_field_boundaries(robot_data['x'], robot_data['y'], self.vx, self.vy)
