...
def go_towards_target(target_position, agent_position, speed=1.3, slow_threshold=300, stop_threshold=80):
    """
    ...
    if distance > stop_threshold:
        if distance > slow_threshold:
            ...
            vx = (delta_x / distance) * speed / 3
            vy = (delta_y / distance) * speed / 3
    else:
        vx, vy = 0, 0
